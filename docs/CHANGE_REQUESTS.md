...
**状态**：spec 已评审定案（`docs/superpowers/specs/2026-09-15-task-hierarchy-design.md`），实施计划已出（`docs/superpowers/plans/2026-09-15-task-hierarchy.md`：17 个任务 / 6 个里程碑 / 3 个提交点），待执行。
